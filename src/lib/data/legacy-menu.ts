...
export const dailyMenuCategories: MenuCategory[] = [
  ...
  },
  {
    ...
    items: [
      ...
      {
        name: "★ M19 Com Chien",
        description: "Vietnamese Wok Fried Rice Served with Vegetables & Soya Sauce (Chicken £14 · Beef £14.50 · King Prawn £16 · Duck £17.50 · Pho Ta Special (Chicken & Prawn) £17.50)", price: "£14 – £17.5", tags: ["Gluten free"], featured: true,
      },
      {
        name: "M20 Com Ca Ri",
